...
struct SettingsView: View {
    ...
    @ObservedObject private var dspSettings = DSPSettings.shared
                ...
                Section {
                    Button {
                        ...
                        HStack {
                            ...
                            Spacer()
                            Text(dspSettings.masterEnabled ? "オン" : "オフ")
                                .font(.footnote)
                                .foregroundStyle(dspSettings.masterEnabled ? Theme.accent : .secondary)
                        }
                    }
                    .tint(.primary)
                } header: {
